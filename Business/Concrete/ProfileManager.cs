...
namespace Business.Concrete
{
    public class ProfileManager : IProfileService
    {
        ...
        public IDataResult<Profile> GetByCity(int cityId)
        {
            return new SuccessDataResult<Profile>(_profileDal.Get(p => p.CityId == cityId));
        }

        public IDataResult<Profile> GetByCountry(int countryId)
        {
            return new SuccessDataResult<Profile>(_profileDal.Get(p => p.CountryId == countryId));
        }
